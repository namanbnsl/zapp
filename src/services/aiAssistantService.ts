...
export class AIAssistantService {
  ...
  static async sendMessage(_userMessage: string, currentSlide?: any): Promise<AIMessage> {
    // Simulate API delay
  ...
  static async getSuggestions(_slideContent: any): Promise<string[]> {
    const suggestions = [
  ...
  static async generateSpeakerNotes(_slideContent: any): Promise<string> {
    const notes = [
